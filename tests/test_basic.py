...
class TestGematikObjektClass:
    ...
    def test_gematikobjekt_class_creation(self, gematik_object):
        assert len(dir(gematik_object)) == 35
        assert gematik_object.id == "GemObj001"
        assert gematik_object.titel == "Titel"
        assert gematik_object.vorgaenger is None
        assert gematik_object.nachfolger is None
        msg = ('id: GemObj001, titel: Titel, vorgaenger: None, '
               'nachfolger: None')
...
#         msg = ('id: A_4646, titel: Titel, vorgaenger: None, nachfolger: '
...
#         self.assertEqual(a.beschreibung, 'Beschreibung')
#         msg = ('id: R4.0.1-2, titel: Titel, vorgaenger: None, nachfolger: '
...
#                            version="V3.7.0",
#                            nachfolger="gemKPT_Betr_V3.6.0")

#         self.assertEqual(len(dir(a)), gematikobjekt_class_len + 2)
#         msg = ('id: gemKPT_Betr_V3.7.0, titel: Titel, vorgaenger: None, '
#                'nachfolger: gemKPT_Betr_V3.6.0, '
#                'dokumentenkuerzel: gemKPT_Betr, '
#                'version: V3.7.0')
#         self.assertEqual(str(a), msg)
